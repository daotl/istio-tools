...
import (
	...
	"github.com/daotl/istio-tools/cmd/kubetype-gen/scanner"
)
...
func main() {
	...
	// arguments.GoHeaderFilePath = filepath.Join(args.DefaultSourceTree(), "github.com/daotl/istio-tools/cmd/kubetype-gen/boilerplate.go.txt")
